...
class Core implements Core_ModuleInterface
{
	...
	static protected $options = array('files_name' => 'files', 'spl_autoload' => false, 'spl_aggressive_autoload' => false,
		'modules_cache' => true, 'modules_cache_path' => '../cache/modules.cache.php');
	...
	protected static function init_module_cache()
	{
		if (Core::option('modules_cache')) {
			...
			if (is_file(self::option('modules_cache_path')) 
				&& ($inc = include_once(self::option('modules_cache_path')))
				&& is_array($inc)
			) {
	...
	static public function cached_modules($module = null, $path = null)
	{
		...
		if (is_null($path) && isset(self::$cached_modules[$module])) {
			return self::$cached_modules[$module];
		}
		if (is_file($path)) {
			self::$flush_modules_cahce = true;
	...
	{
		self::push_dir();
		if (Core::option('spl_aggressive_autoload')) {
			return;
		}
	 ...
	 * @return boolean
	 */
	static public function is_loaded($module)
	{
		return self::$loader->is_loaded($module);
	}
	 ...
	 * @return ArrayObject
	 */
	static public function hash($values = array())
	{
	...
	static public function clear_invoke_cache()
	{
		return WS::env()->cache->delete("cached_invoke");
	}
	 ...
	 * @return Object
	 */
	static public function with($object)
	{
		return $object;
	}
	 ...
	 * @return Object
	 */
	static public function with_clone($object)
	{
		return clone $object;
	}
	 ...
	 * @return mixed
	 */
	static public function with_index($object, $index)
	{
		return $object[$index];
	}
	 ...
	 * @return mixed
	 */
	static public function with_attr($object, $attr)
	{
		return $object->$attr;
	}
...
class Core_Call implements Core_InvokeInterface
{
	...
	{
		if (Core_Strings::starts_with($str, 'Core.Call')) {
...
class Core_ModuleLoader implements Core_ModuleLoaderInterface
{
	...
	public function merge(Core_ModuleLoaderInterface $instance)
	{
		...
		foreach ($this->loaded as $module => $v)
			if ($v) {
				$instance->already_loaded($module);
			}
		return $instance;
	}
		...
		foreach ($this->paths as $name => $root) {
			...
			if (preg_match(
				...
				return $root . '/' . str_replace(
					'.', '/',
					$drop_prefix ? preg_replace("{^$name.}", '', $module) : $module
				) . '.php';
			}
		}
...
class Core_Regexps
{
	 ...
	 * @return boolean
	 */
	static public function match($regexp, $string)
	{
...
// TODO: eliminate if
	 ...
	 * @return string
	 */
	static public function chop($tail)
	{
		return rtrim($tail);
	}
	 ...
	 * @return boolean
	 */
	static public function starts_with($string, $head)
	{
	 ...
	 * @return string
	 */
	static public function downcase($string)
	{
	 ...
	 * @return string
	 */
	static public function decode64($string)
	{
	 ...
	 * @return string
	 */
	static public function encode64($string)
	{
...
class Core_Types
{
	 ...
	 * @return boolean
	 */
	static public function is_array(&$object)
	{
	 ...
	 * @return boolean
	 */
	static public function is_string(&$object)
	{
	 ...
	 * @return boolean
	 */
	static public function is_number(&$object)
	{
	 ...
	 * @return boolean
	 */
	static public function is_object(&$object)
	{
	 ...
	 * @return boolean
	 */
	static public function is_resource(&$object)
	{
	 ...
	 * @return string
	 */
	static public function virtual_class_name_for($object)
	{
	 ...
	 * @return string
	 */
	static public function real_class_name_for($object)
	{
...
class Core_Arrays
{
	 ...
	 * @return array
	 */
	static public function keys(array &$array)
	{
	 ...
	 * @return mixed
	 */
	static public function shift(array &$array)
	{
	 ...
	 * @return mixed
	 */
	static public function pop(array &$array)
	{
...
// TODO: $x -> $v
	 ...
	 * @return array
	 */
	static public function merge(array $what, array $with)
	{
	 ...
	 * @return string
	 */
	static public function join_with($delimiter, array $array)
	{
