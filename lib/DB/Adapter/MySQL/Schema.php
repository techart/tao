 ...
 */
class DB_Adapter_MySQL_Schema implements DB_Adapter_SchemaInterface, Core_ModuleInterface
{
	...
	public function column_definition($column)
	{
		...
		if (isset($column['mysql_definition'])) {
			return $column['mysql_definition'];
		}
