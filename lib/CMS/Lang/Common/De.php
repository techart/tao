...
/**
 * @package CMS\Lang\Common\De
 */
class CMS_Lang_Common_De implements Core_ModuleInterface
{

	const MODULE = 'CMS.Lang.Common.De';
	const VERSION = '0.0.0';
	...
	public $dwshort = array('mo', 'di', 'mi', 'do', 'fr', 'sa', 'so');
	public $name = 'Name';
	...
	public $ta_del_confirm = 'Do you want to delete this item?';
	public $ta_del_confirm_multi = 'Do you want to delete this items?';
	public $ta_del_selected = 'Delete selected';
	public $ta_nothing_selected = 'Nothing selected';
	...
	public $manage_caches = 'Manage Cache';
