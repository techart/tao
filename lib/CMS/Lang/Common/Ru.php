...
class CMS_Lang_Common_Ru implements Core_ModuleInterface
{
	...
	public $dwshort = array('пн', 'вт', 'ср', 'чт', 'пт', 'сб', 'вс');
	...
	public $ta_del_confirm_multi = 'Вы действительно хотите удалить эти записи?';
	public $ta_del_selected = 'Удалить выбранные';
	public $ta_nothing_selected = 'Не выбрано ни одной записи';
	...
	public $ta_addtie = 'Добавить связь';
	...
	public $manage_caches = 'Управление кешированием';
